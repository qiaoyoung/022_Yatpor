...
static CGFloat const notiPathLabelStr = 3;

//: @implementation YasicClipAreaLayer
@implementation PhoneMessageShapeLayer
...
- (void)drawInContext:(CGContextRef)ctx
{
    ...
    CGContextSetLineWidth(ctx, notiPathLabelStr);
...
- (void)georgiaHomeBoy:(NSInteger)cropAreaLeft identifyFile:(NSInteger)cropAreaTop between:(NSInteger)cropAreaRight area:(NSInteger)cropAreaBottom
{
    //: _cropAreaLeft = cropAreaLeft;
    _cropAreaLeft = cropAreaLeft;
    //: _cropAreaRight = cropAreaRight;
