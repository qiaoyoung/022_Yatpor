...
- (void)ting{
    ...
    self.thumb.center = [self thumbEnable:_value];
...
- (CGPoint)thumbEnable:(CGFloat)value{
...
- (void)setBufferProgress:(CGFloat)bufferProgress{
    ...
    bufferProgress = [self appearance:bufferProgress];
...
- (void)ting:(UIImage *)thumbImage data:(UIControlState)state{
...
- (void)imageAdd:(BOOL)isFullScreen{
    //: _frame = self.bounds;
    _frame = self.bounds;
    //: [self creatUI];
    [self ting];
