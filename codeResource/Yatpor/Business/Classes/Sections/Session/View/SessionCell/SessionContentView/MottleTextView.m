...
- (void)valueRow:(PossibilityMessageStyle *)data
{
    ...
    if ([attachment isKindOfClass:[StyleBubble class]]) {
        ...
        self.imageView.image = [attachment sizeCell];
...
- (UIImage *)ting:(UIControlState)state sharedOutgoing:(BOOL)outgoing{
    ...
    return [super ting:state sharedOutgoing:outgoing];
}
