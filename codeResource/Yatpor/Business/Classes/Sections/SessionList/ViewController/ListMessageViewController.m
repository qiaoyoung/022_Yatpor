...
typedef struct {
    ...
    Byte toiletKitRelease;
	int titleButtonStart;
} TitleData;
...
TitleData noti_labTitle = (TitleData){107, (Byte []){24, 14, 31, 31, 2, 5, 12, 52, 27, 25, 2, 29, 10, 8, 18, 52, 8, 10, 6, 14, 25, 10, 106}, 22, 254, 236};

//: invite_you_group
TitleData app_contentMessage = (TitleData){17, (Byte []){120, 127, 103, 120, 101, 116, 78, 104, 126, 100, 78, 118, 99, 126, 100, 97, 86}, 16, 215, 22};

//: type
TitleData app_windowKey = (TitleData){93, (Byte []){41, 36, 45, 56, 215}, 4, 178, 30};

//: (连接中)
TitleData mainWindowData = (TitleData){145, (Byte []){185, 121, 46, 15, 119, 31, 52, 117, 41, 60, 184, 54}, 11, 204, 202};

//: contact_tag_fragment_cancel
TitleData mFrameMessage = (TitleData){9, (Byte []){106, 102, 103, 125, 104, 106, 125, 86, 125, 104, 110, 86, 111, 123, 104, 110, 100, 108, 103, 125, 86, 106, 104, 103, 106, 108, 101, 209}, 27, 162, 220};

//: code
TitleData mainModelFormat = (TitleData){63, (Byte []){92, 80, 91, 90, 156}, 4, 208, 108};

//: home_notice
TitleData showReleaseData = (TitleData){129, (Byte []){233, 238, 236, 228, 222, 239, 238, 245, 232, 226, 228, 195}, 11, 152, 188};

//: icon_session_list_empty
TitleData kSizeContent = (TitleData){97, (Byte []){8, 2, 14, 15, 62, 18, 4, 18, 18, 8, 14, 15, 62, 13, 8, 18, 21, 62, 4, 12, 17, 21, 24, 88}, 23, 185, 215};

//: owner
TitleData show_ofValue = (TitleData){49, (Byte []){94, 70, 95, 84, 67, 94}, 5, 172, 192};

//: ic_top
TitleData main_dotUrl = (TitleData){90, (Byte []){51, 57, 5, 46, 53, 42, 114}, 6, 221, 62};

//: ic_add_fiend
TitleData userButtonMessage = (TitleData){3, (Byte []){106, 96, 92, 98, 103, 103, 92, 101, 106, 102, 109, 103, 89}, 12, 201, 90};

//: #875FFA
TitleData show_containerUrl = (TitleData){81, (Byte []){114, 105, 102, 100, 23, 23, 16, 166}, 7, 187, 136};

//: tag_activity_set
TitleData app_shareFormat = (TitleData){78, (Byte []){58, 47, 41, 17, 47, 45, 58, 39, 56, 39, 58, 55, 17, 61, 43, 58, 56}, 16, 207, 162};

//: my_computer
TitleData dreamRemoteMessage = (TitleData){83, (Byte []){62, 42, 12, 48, 60, 62, 35, 38, 39, 54, 33, 241}, 11, 209, 254};

//: globalsign
TitleData k_accountStr = (TitleData){64, (Byte []){39, 44, 47, 34, 33, 44, 51, 41, 39, 46, 137}, 10, 180, 143};

//: #5D5F66
TitleData userMessageMsg = (TitleData){182, (Byte []){149, 131, 242, 131, 240, 128, 128, 2}, 7, 194, 37};

//: /user/checkcreateteam
TitleData notiVerticalTitle = (TitleData){138, (Byte []){165, 255, 249, 239, 248, 165, 233, 226, 239, 233, 225, 233, 248, 239, 235, 254, 239, 254, 239, 235, 231, 133}, 21, 201, 138};

//: ic_delete
TitleData dream_resourceUrl = (TitleData){237, (Byte []){132, 142, 178, 137, 136, 129, 136, 153, 136, 252}, 9, 231, 126};

//: no_conversation
TitleData show_dotTitle = (TitleData){178, (Byte []){220, 221, 237, 209, 221, 220, 196, 215, 192, 193, 211, 198, 219, 221, 220, 165}, 15, 184, 137};

//: retracted_message
TitleData notiLabStr = (TitleData){68, (Byte []){54, 33, 48, 54, 37, 39, 48, 33, 32, 27, 41, 33, 55, 55, 37, 35, 33, 134}, 17, 255, 198};
...
//: name
TitleData notiFrameId = (TitleData){7, (Byte []){105, 102, 106, 98, 104}, 4, 233, 36};

//: /team/create
TitleData m_needUrl = (TitleData){139, (Byte []){164, 255, 238, 234, 230, 164, 232, 249, 238, 234, 255, 238, 227}, 12, 200, 196};

//: activity_create_group_name_create_group
TitleData showShareEnableName = (TitleData){40, (Byte []){73, 75, 92, 65, 94, 65, 92, 81, 119, 75, 90, 77, 73, 92, 77, 119, 79, 90, 71, 93, 88, 119, 70, 73, 69, 77, 119, 75, 90, 77, 73, 92, 77, 119, 79, 90, 71, 93, 88, 151}, 39, 181, 170};

//: (未连接)
TitleData kDataBubbleStr = (TitleData){122, (Byte []){82, 156, 230, 208, 146, 197, 228, 156, 244, 223, 83, 205}, 11, 255, 234};

//: tname
TitleData main_globalMessage = (TitleData){169, (Byte []){221, 199, 200, 196, 204, 62}, 5, 163, 185};

//: jpg
TitleData noti_messageKey = (TitleData){97, (Byte []){11, 17, 6, 114}, 3, 174, 226};

//: ic_topno
TitleData user_messageData = (TitleData){114, (Byte []){27, 17, 45, 6, 29, 2, 28, 29, 202}, 8, 252, 155};

//: quick_icon
TitleData user_dismissTitle = (TitleData){118, (Byte []){7, 3, 31, 21, 29, 41, 31, 21, 25, 24, 219}, 10, 245, 35};

//: team_create_helper_create_failed
TitleData showGrayId = (TitleData){59, (Byte []){79, 94, 90, 86, 100, 88, 73, 94, 90, 79, 94, 100, 83, 94, 87, 75, 94, 73, 100, 88, 73, 94, 90, 79, 94, 100, 93, 90, 82, 87, 94, 95, 178}, 32, 240, 162};

//: ic_nodistrub
TitleData k_upTingMessage = (TitleData){208, (Byte []){185, 179, 143, 190, 191, 180, 185, 163, 164, 162, 165, 178, 225}, 12, 231, 206};

//: (同步数据)
TitleData show_touchName = (TitleData){130, (Byte []){170, 103, 18, 14, 100, 47, 39, 100, 23, 50, 100, 15, 44, 171, 58}, 14, 175, 234};

//: fragment_contact_new_scan
TitleData main_windowMsg = (TitleData){218, (Byte []){188, 168, 187, 189, 183, 191, 180, 174, 133, 185, 181, 180, 174, 187, 185, 174, 133, 180, 191, 173, 133, 169, 185, 187, 180, 189}, 25, 232, 3};

//: add_friend_activity_add_friend
TitleData notiSelectedValue = (TitleData){3, (Byte []){98, 103, 103, 92, 101, 113, 106, 102, 109, 103, 92, 98, 96, 119, 106, 117, 106, 119, 122, 92, 98, 103, 103, 92, 101, 113, 106, 102, 109, 103, 236}, 30, 229, 33};

//: quickchat
TitleData mainCommentIdent = (TitleData){25, (Byte []){104, 108, 112, 122, 114, 122, 113, 120, 109, 68}, 9, 206, 200};

//: ic_create_chat
TitleData show_modelStr = (TitleData){24, (Byte []){113, 123, 71, 123, 106, 125, 121, 108, 125, 71, 123, 112, 121, 108, 60}, 14, 187, 224};

//: [有人@你]
TitleData appStateMessage = (TitleData){22, (Byte []){77, 240, 138, 159, 242, 172, 172, 86, 242, 171, 182, 75, 225}, 12, 252, 81};

//: activity_user_profile_chat
TitleData noti_removeMessage = (TitleData){238, (Byte []){143, 141, 154, 135, 152, 135, 154, 151, 177, 155, 157, 139, 156, 177, 158, 156, 129, 136, 135, 130, 139, 177, 141, 134, 143, 154, 164}, 26, 254, 213};

//: ic_distrub
TitleData dream_removeData = (TitleData){48, (Byte []){89, 83, 111, 84, 89, 67, 68, 66, 69, 82, 206}, 10, 177, 79};

//: ic_scan
TitleData mainShouldUrl = (TitleData){89, (Byte []){48, 58, 6, 42, 58, 56, 55, 219}, 7, 164, 70};

//: user_info_avtivity_upload_avatar_failed
TitleData kWithId = (TitleData){97, (Byte []){20, 18, 4, 19, 62, 8, 15, 7, 14, 62, 0, 23, 21, 8, 23, 8, 21, 24, 62, 20, 17, 13, 14, 0, 5, 62, 0, 23, 0, 21, 0, 19, 62, 7, 0, 8, 13, 4, 5, 19}, 39, 179, 41};

//: notification
TitleData kCountData = (TitleData){186, (Byte []){212, 213, 206, 211, 220, 211, 217, 219, 206, 211, 213, 212, 168}, 12, 194, 165};

//: tid
TitleData noti_selectedMsg = (TitleData){15, (Byte []){123, 102, 107, 120}, 3, 193, 219};

//: home_create_group
TitleData kDateUrl = (TitleData){183, (Byte []){223, 216, 218, 210, 232, 212, 197, 210, 214, 195, 210, 232, 208, 197, 216, 194, 199, 228}, 17, 216, 18};

//: home_add_friend
TitleData kKeyTitle = (TitleData){138, (Byte []){226, 229, 231, 239, 213, 235, 238, 238, 213, 236, 248, 227, 239, 228, 238, 11}, 15, 223, 118};

//: #999999
TitleData show_textUrl = (TitleData){189, (Byte []){158, 132, 132, 132, 132, 132, 132, 138}, 7, 237, 142};

//: please_contact_your_administrator
TitleData showRemoveNeedMessage = (TitleData){11, (Byte []){123, 103, 110, 106, 120, 110, 84, 104, 100, 101, 127, 106, 104, 127, 84, 114, 100, 126, 121, 84, 106, 111, 102, 98, 101, 98, 120, 127, 121, 106, 127, 100, 121, 123}, 33, 215, 104};
...
@interface ListMessageViewController ()<NIMLoginManagerDelegate,SizeDelegate,NIMEventSubscribeManagerDelegate,UIViewControllerPreviewingDelegate,NIMChatExtendManagerDelegate, NIMConversationManagerDelegate,OptionName,NIMSystemNotificationManagerDelegate>
...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil{
    ...
    if (self) {
        ...
        self.autoRemoveRemoteSession = [[PassageSetting language] imageMax];
    }
    //: return self;
    return self;
}
...
//    [self setupDropDownMenu];
    ...
    self.tableView.frame = CGRectMake(15,15, [[UIScreen mainScreen] bounds].size.width-30, ([[UIScreen mainScreen] bounds].size.height - (44.0f + [UIDevice bearDown]) - (({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom))-210);
    ...
    self.header = [[CropBarView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, 0)];
    ...
    self.emptyImageView.image = [UIImage imageNamed:StringFromTitleData(&kSizeContent)];
    ...
    self.emptyTipLabel.textColor = [UIColor recordView:StringFromTitleData(&show_textUrl)];
    ...
    if(![[NameDefaults argument].yspop isEqualToString:@"1"]){
    ...
    [TroublingName nameConfig:^(NSDictionary * _Nonnull configDict) {
        ...
        if (configDict.allKeys.count > 0) {
            ...
            NSString *globalsign = [configDict to:StringFromTitleData(&k_accountStr)];
            ...
            if (globalsign.integerValue > 0) {
                ...
                ElectronicNetworkView *sheet = [[ElectronicNetworkView alloc] initWithLiftButton:self.view.bounds green:@{}];
                //: sheet.delegate = self;
                sheet.delegate = self;
                //: [sheet show];
                [sheet arrayShow];
...
-(void)model{
    ...
    [TroublingName allowFailed:[NSString stringWithFormat:StringFromTitleData(&notiVerticalTitle)] table:nil carteDuJour:NO behindValue:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict to:StringFromTitleData(&mainModelFormat)];
...
- (void)portion{
    ...
    UIView *topview = [[UIView alloc]initWithFrame:CGRectMake(0, [UIDevice bearDown], [[UIScreen mainScreen] bounds].size.width, 180)];
    ...
    [moreBtn addTarget:self action:@selector(videoPress) forControlEvents:UIControlEventTouchUpInside];
    //: [moreBtn setImage:[UIImage imageNamed:@"ic_scan"] forState:UIControlStateNormal];
    [moreBtn setImage:[UIImage imageNamed:StringFromTitleData(&mainShouldUrl)] forState:UIControlStateNormal];
    ...
    UITapGestureRecognizer *singleTap1 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(parentIndex)];
    ...
    UIImageView *image1 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromTitleData(&kKeyTitle)]];
...
//    label12.textAlignment = NSTextAlignmentCenter;
    ...
    UITapGestureRecognizer *singleTap2 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(nameEnable)];
    //: [box2 addGestureRecognizer:singleTap2];
    [box2 addGestureRecognizer:singleTap2];

    //: UIImageView *image2 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"home_notice"]];
    UIImageView *image2 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromTitleData(&showReleaseData)]];
...
//    label2.textAlignment = NSTextAlignmentCenter;
    ...
    UIImageView *image3 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromTitleData(&kDateUrl)]];
...
//    [_resqBtn setImage:[UIImage imageNamed:@"home_create_group"] forState:UIControlStateNormal];
    ...
    [_resqBtn addTarget:self action:@selector(readTing) forControlEvents:UIControlEventTouchUpInside];
...
- (void)showEnable {
    ...
    _mesBtn.backgroundColor = [UIColor recordView:StringFromTitleData(&show_containerUrl)];
    //: [_resqBtn setTitleColor:[UIColor colorWithHexString:@"#5D5F66"] forState:UIControlStateNormal];
    [_resqBtn setTitleColor:[UIColor recordView:StringFromTitleData(&userMessageMsg)] forState:UIControlStateNormal];
...
- (void)sizeDomain {
    ...
    _resqBtn.backgroundColor = [UIColor recordView:StringFromTitleData(&show_containerUrl)];
    //: [_mesBtn setTitleColor:[UIColor colorWithHexString:@"#5D5F66"] forState:UIControlStateNormal];
    [_mesBtn setTitleColor:[UIColor recordView:StringFromTitleData(&userMessageMsg)] forState:UIControlStateNormal];
...
- (void)inheritance:(NIMRecentSession *)recent title:(NSIndexPath *)indexPath{
    //: NTESSessionViewController *vc = [[NTESSessionViewController alloc] initWithSession:recent.session];
    SessionSizeViewController *vc = [[SessionSizeViewController alloc] initWithNameExtra:recent.session];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}

//: - (void)onSelectedAvatar:(NIMRecentSession *)recent
- (void)elite:(NIMRecentSession *)recent
    ...
    if (recent.session.sessionType == NIMSessionTypeP2P) {
        ...
        vc = [[BarViewController alloc] initWithScale:recent.session.sessionId];
        //: [self.navigationController pushViewController:vc animated:YES];
        [self.navigationController pushViewController:vc animated:YES];
    }
}
...
- (void)label:(NIMRecentSession *)recent indexPath:(NSIndexPath *)indexPath
{
    ...
    [manager deleteRecentSession:recent option:option completion:^(NSError * _Nullable error) {
        ...
        if (!error) {
            ...
            self.recentSessions = [self image:self.recentSessions];
            //: [self refresh];
            [self index];
        }
    //: }];
...
- (void)with:(NIMRecentSession *)recent
                   //: atIndexPath:(NSIndexPath *)indexPath
                   progress:(NSIndexPath *)indexPath
                         //: isTop:(BOOL)isTop
                         frame:(BOOL)isTop
{
    //: if (isTop)
...
- (void)pressMember:(NIMRecentSession *)recent session:(BOOL)isDis
{
    ...
    if (recent.session.sessionType == NIMSessionTypeTeam) {
        ...
        info = [[UserKit totalSend] search:recent.session.sessionId speedy:nil];
    ...
    //: } else if (recent.session.sessionType == NIMSessionTypeP2P) {
        ...
        info = [[UserKit totalSend] color:recent.session.sessionId image:option];
...
- (void)onLogin:(NIMLoginStep)step {
    ...
    switch (step) {
        ...
        case NIMLoginStepLinkFailed:
            ...
            self.navigationItem.title = StringFromTitleData(&kDataBubbleStr).with;
            //: break;
            break;
        //: case NIMLoginStepLinking:
        case NIMLoginStepLinking:
            //: self.navigationItem.title = @"(连接中)".ntes_localized;
            self.navigationItem.title = StringFromTitleData(&mainWindowData).with;
            //: break;
            break;
        ...
        case NIMLoginStepSyncing:
            ...
            self.navigationItem.title = StringFromTitleData(&show_touchName).with;
            //: break;
            break;
        //: default:
        default:
...
- (UISwipeActionsConfiguration *)tableView:(UITableView *)tableView trailingSwipeActionsConfigurationForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIContextualAction *deleteAction1 = [UIContextualAction contextualActionWithStyle:UIContextualActionStyleNormal title:nil handler:^(UIContextualAction * _Nonnull action, __kindof UIView * _Nonnull sourceView, void (^ _Nonnull completionHandler)(BOOL)) {
        ...
        [self label:recentSession indexPath:indexPath];
        //: [tableView setEditing:NO animated:YES];
        [tableView setEditing:NO animated:YES];
    ...
    UIContextualAction *deleteAction2 = [UIContextualAction contextualActionWithStyle:UIContextualActionStyleNormal title:nil handler:^(UIContextualAction * _Nonnull action, __kindof UIView * _Nonnull sourceView, void (^ _Nonnull completionHandler)(BOOL)) {
        ...
        [self with:recentSession progress:indexPath frame:isTop];
    //: }];
    }];
    ...
    if (recentSession.session.sessionType == NIMSessionTypeTeam) {
        ...
        info = [[UserKit totalSend] search:recentSession.session.sessionId speedy:nil];
        //: NIMTeamNotifyState notifyState = [[[NIMSDK sharedSDK] teamManager] notifyStateForNewMsg:info.infoId];
        NIMTeamNotifyState notifyState = [[[NIMSDK sharedSDK] teamManager] notifyStateForNewMsg:info.infoId];
    ...
    //: } else if (recentSession.session.sessionType == NIMSessionTypeP2P) {
        ...
        info = [[UserKit totalSend] color:recentSession.session.sessionId image:option];
    ...
    UIContextualAction *deleteAction3 = [UIContextualAction contextualActionWithStyle:UIContextualActionStyleNormal title:nil handler:^(UIContextualAction * _Nonnull action, __kindof UIView * _Nonnull sourceView, void (^ _Nonnull completionHandler)(BOOL)) {
        ...
        [self pressMember:recentSession session:isDisnodistrub];
    //: }];
    }];
...
//    //只能设置背景颜色，图片，文字
    ...
    deleteAction1.image = [UIImage imageNamed:StringFromTitleData(&dream_resourceUrl)];
//
    ...
    if(isTop){
        ...
        deleteAction2.image = [UIImage imageNamed:StringFromTitleData(&user_messageData)];
    //: }else{
    }else{
        //: deleteAction2.image = [UIImage imageNamed:@"ic_top"];
        deleteAction2.image = [UIImage imageNamed:StringFromTitleData(&main_dotUrl)];
    }
    ...
    if(isDisnodistrub){
        ...
        deleteAction3.image = [UIImage imageNamed:StringFromTitleData(&dream_removeData)];
    //: }else{
    }else{
        //: deleteAction3.image = [UIImage imageNamed:@"ic_nodistrub"];
        deleteAction3.image = [UIImage imageNamed:StringFromTitleData(&k_upTingMessage)];
    }
//    // 创建包含图片和文字的自定义视图
...
- (void)forename{
    ...
    self.header.top = [UIDevice bearDown]+180;
...
- (NSAttributedString *)more:(NIMRecentSession *)recent{
    ...
    if (recent.lastMessage.messageType == NIMMessageTypeCustom)
    {
        ...
        NSString *text = [NatalDayComplete text:msg];
        //: if (recent.session.sessionType != NIMSessionTypeP2P)
        if (recent.session.sessionType != NIMSessionTypeP2P)
        {
            //: NSString *nickName = [NTESSessionUtil showNick:msg.from inSession:msg.session];
            NSString *nickName = [LanguageUtil searchedSession:msg.from session:msg.session];
    ...
    [self listing:recent flush:attContent];
    //: [self checkOnlineState:recent content:attContent];
    [self canvassTextStateDoingLineStop:recent view_strong:attContent];

    //: NSMutableAttributedString *resultS = [self transformEmojiDescToEomjiImageWithAttributedString:attContent];
    NSMutableAttributedString *resultS = [self exceptTap:attContent];
...
- (NSMutableAttributedString *)exceptTap:(NSAttributedString *)attributedString {
    // 匹配 [表情]
    ...
    if (attrM.length > 0) {
        ...
        NSArray<NSTextCheckingResult *> *emoticonResults = [[ListMessageViewController input] matchesInString:attrM.string options:kNilOptions range:attrM.yy_rangeOfAll];
        ...
        [emoticonResults enumerateObjectsWithOptions:NSEnumerationReverse usingBlock:^(NSTextCheckingResult * _Nonnull emo, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            UIImage *image = [UIImage secretRandom:emoticon.filename];
...
- (void)listing:(NIMRecentSession *)recent flush:(NSMutableAttributedString *)content
{
    //: if ([NTESSessionUtil recentSessionIsMark:recent type:NTESRecentSessionMarkTypeAt]) {
    if ([LanguageUtil pin:recent index:NTESRecentSessionMarkTypeAt]) {
        ...
        NSAttributedString *atTip = [[NSAttributedString alloc] initWithString:StringFromTitleData(&appStateMessage).with attributes:@{NSForegroundColorAttributeName:[UIColor redColor]}];
...
- (void)canvassTextStateDoingLineStop:(NIMRecentSession *)recent view_strong:(NSMutableAttributedString *)content
{
    //: if (recent.session.sessionType == NIMSessionTypeP2P) {
    if (recent.session.sessionType == NIMSessionTypeP2P) {
//        NSString *state  = [LanguageUtil onlineState:recent.session.sessionId detail:NO];
//        if (state.length) {
...
-(void)colorType:(NSString *)teamID withType:(NSString *)teamName message:(NSString *)type{
    //: NSString *currentUserId = [[NIMSDK sharedSDK].loginManager currentAccount];
    NSString *currentUserId = [[NIMSDK sharedSDK].loginManager currentAccount];
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"owner"] = currentUserId;
    dict[StringFromTitleData(&show_ofValue)] = currentUserId;
    //: dict[@"type"] = type;
    dict[StringFromTitleData(&app_windowKey)] = type;
    //: dict[@"tname"] = teamName;
    dict[StringFromTitleData(&main_globalMessage)] = teamName;
    //: dict[@"tid"] = teamID;
    dict[StringFromTitleData(&noti_selectedMsg)] = teamID;

}

//: - (void)presentMemberSelector:(ContactSelectFinishBlock) block{
- (void)heritage:(ContactSelectFinishBlock) block{
...
- (void)system:(ContactSelectFinishBlock) block{
    //: NSMutableArray *users = [[NSMutableArray alloc] init];
    NSMutableArray *users = [[NSMutableArray alloc] init];
    //使用内置的好友选择器
    //: NIMContactFriendSelectConfig *config = [[NIMContactFriendSelectConfig alloc] init];
...
- (void)information {
    ...
    self.dropdownMenu = [FFDropDownMenuView new];
     ...
     self.dropdownMenu.triangleY = [UIDevice bearDown] +30;
    ...
    self.dropdownMenu.cellClassName = @"ObjectViewCell";
...
-(void)line{
    ...
    [self heritage:^(NSArray *uids, NSString *name, UIImage *avater) {
        @
         //: try{} @finally{} __typeof__(self) self = __weak_self__;
         try{} @finally{} __typeof__(self) self = __weak_self__;
                        ;
...
//        [SVProgressHUD show];
        ...
        [self childSession:avater name:^(NSString *urlString) {
...
//                [SVProgressHUD dismiss];
                ...
                if (!error) {
                    ...
                    [self colorType:teamId withType:option.name message:@"1"];
...
- (void)childSession:(UIImage *)image name:(void(^)(NSString *urlString ))complete {
...
-(void)toProvider:(NSString *)groupName cropComplete:(NSString *)teamId{
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"name"] = groupName;
    dict[StringFromTitleData(&notiFrameId)] = groupName;
    //: dict[@"id"] = teamId;
    dict[@"id"] = teamId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/team/create"] params:dict isShow:NO success:^(id responseObject) {
    [TroublingName allowFailed:[NSString stringWithFormat:StringFromTitleData(&m_needUrl)] table:dict carteDuJour:NO behindValue:^(id responseObject) {
...
- (void)dateChat
{
    ...
    [self system:^(NSArray *uids, NSString *name, UIImage *avater) {
        @
         //: try{} @finally{} __typeof__(self) self = __weak_self__;
         try{} @finally{} __typeof__(self) self = __weak_self__;
                        ;
...
- (NotificationView *)noticeView
{
    ...
    if(!_noticeView){
        ...
        _noticeView = [[NotificationView alloc]initWithFrame:CGRectMake(0, [UIDevice bearDown]+140, [[UIScreen mainScreen] bounds].size.width, ([[UIScreen mainScreen] bounds].size.height - (44.0f + [UIDevice bearDown]) - (({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom))-140)];
...
- (UIButton *)QuickChatBtn
{
    ...
    if (!_QuickChatBtn) {
        ...
        [_QuickChatBtn setImage:[UIImage imageNamed:StringFromTitleData(&user_dismissTitle)] forState:UIControlStateNormal];
        //: [_QuickChatBtn addTarget:self action:@selector(handlerQuickChat) forControlEvents:UIControlEventTouchUpInside];
        [_QuickChatBtn addTarget:self action:@selector(dateChat) forControlEvents:UIControlEventTouchUpInside];
...
Byte *TitleDataToByte(TitleData *data) {
    if (data->toiletKitRelease < 125) return data->addTogether;
    for (int i = 0; i < data->checked; i++) {
        data->addTogether[i] ^= data->dataDate;
    }
    data->addTogether[data->checked] = 0;
    data->toiletKitRelease = 24;
	if (data->checked >= 1) {
		data->titleButtonStart = data->addTogether[0];
	}
    return data->addTogether;
}
