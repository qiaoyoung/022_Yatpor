...
@interface QuickSuccess : NSObject
...
@property (nonatomic, copy) NSArray <MessageDisturbing *> *phones;
...
@interface MessageDisturbing : NSObject
...
@interface DoingLength : NSObject

//: @property (nonatomic, copy) NSString *key;
@property (nonatomic, copy) NSString *key;

//: @property (nonatomic, copy) NSArray <CCCContactPerson *> *persons;
@property (nonatomic, copy) NSArray <QuickSuccess *> *persons;
