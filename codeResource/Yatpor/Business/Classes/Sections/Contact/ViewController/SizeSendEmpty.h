...
@interface SizeSendEmpty : NSObject

//: + (instancetype)sharedInstance;;
+ (instancetype)aboveShowInstance;;
...
- (void)layerShowView:(void (^)(BOOL succeed, NSArray <QuickSuccess *> *contacts))completcion;
...
- (void)add:(void (^)(BOOL succeed, NSArray <DoingLength *> *contacts, NSArray <NSString *> *keys))completcion;
