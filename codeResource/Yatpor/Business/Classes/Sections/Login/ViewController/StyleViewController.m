...
NSString *StringFromPlanetaryData(Byte *data);


//: user_profile_avtivity_head
Byte app_ofKey[] = {8, 26, 62, 14, 202, 144, 21, 58, 190, 222, 247, 247, 215, 189, 179, 177, 163, 176, 157, 174, 176, 173, 164, 167, 170, 163, 157, 159, 180, 178, 167, 180, 167, 178, 183, 157, 166, 163, 159, 162, 208};

//: contact_tag_fragment_cancel
Byte appNeedKey[] = {74, 27, 90, 13, 213, 30, 220, 95, 187, 159, 33, 229, 27, 189, 201, 200, 206, 187, 189, 206, 185, 206, 187, 193, 185, 192, 204, 187, 193, 199, 191, 200, 206, 185, 189, 187, 200, 189, 191, 198, 65};

//: register_avtivity3_avatar
Byte app_shouldFormat[] = {82, 25, 89, 4, 203, 190, 192, 194, 204, 205, 190, 203, 184, 186, 207, 205, 194, 207, 194, 205, 210, 140, 184, 186, 207, 186, 205, 186, 203, 114};

//: ko-KP
Byte showStateLabText[] = {23, 5, 56, 12, 78, 131, 81, 232, 145, 192, 154, 237, 163, 167, 101, 131, 136, 95};

//: #5D5F66
Byte show_keyCountUrl[] = {32, 7, 72, 9, 239, 100, 203, 33, 39, 107, 125, 140, 125, 142, 126, 126, 204};

//: back_arrow_bl
Byte m_messageShowData[] = {96, 13, 24, 5, 50, 122, 121, 123, 131, 119, 121, 138, 138, 135, 143, 119, 122, 132, 17};

//: hant
Byte userSizeName[] = {94, 4, 56, 12, 220, 182, 229, 106, 199, 62, 156, 244, 160, 153, 166, 172, 35};

//: head_default
Byte dreamLineData[] = {64, 12, 12, 9, 137, 151, 62, 129, 47, 116, 113, 109, 112, 107, 112, 113, 114, 109, 129, 120, 128, 237};

//: message_send_album
Byte user_accountValue[] = {91, 18, 97, 12, 86, 3, 81, 111, 139, 74, 120, 93, 206, 198, 212, 212, 194, 200, 198, 192, 212, 198, 207, 197, 192, 194, 205, 195, 214, 206, 184};

//: login_bg
Byte notiCollectionName[] = {86, 8, 66, 11, 183, 150, 79, 131, 69, 198, 106, 174, 177, 169, 171, 176, 161, 164, 169, 237};

//: setting_privacy
Byte notiByContent[] = {60, 15, 12, 10, 218, 147, 160, 103, 190, 230, 127, 113, 128, 128, 117, 122, 115, 107, 124, 126, 117, 130, 109, 111, 133, 66};

//: register_good_avater
Byte userTextData[] = {73, 20, 99, 11, 234, 169, 86, 205, 161, 78, 89, 213, 200, 202, 204, 214, 215, 200, 213, 194, 202, 210, 210, 199, 194, 196, 217, 196, 215, 200, 213, 154};

//: zh-Hans
Byte show_viewValue[] = {8, 7, 16, 8, 123, 139, 248, 84, 138, 120, 61, 88, 113, 126, 131, 138};

//: #F7BA00
Byte noti_containerMsg[] = {59, 7, 62, 7, 217, 156, 4, 97, 132, 117, 128, 127, 110, 110, 2};

//: #000000
Byte app_beginValue[] = {43, 7, 6, 10, 247, 144, 179, 249, 91, 41, 41, 54, 54, 54, 54, 54, 54, 14};

//: nickname
Byte noti_imageMessage[] = {32, 8, 95, 6, 215, 133, 205, 200, 194, 202, 205, 192, 204, 196, 212};

//: tag_activity_set
Byte appCommentImageKey[] = {50, 16, 43, 13, 222, 148, 244, 81, 80, 153, 116, 21, 210, 159, 140, 146, 138, 140, 142, 159, 148, 161, 148, 159, 164, 138, 158, 144, 159, 180};

//: ic_hi
Byte dream_redMsg[] = {99, 5, 38, 13, 246, 248, 17, 94, 34, 66, 227, 40, 141, 143, 137, 133, 142, 143, 156};

//: spa
Byte notiLayerStr[] = {3, 3, 56, 14, 12, 83, 111, 165, 97, 245, 239, 88, 125, 151, 171, 168, 153, 120};

//: icon_photo
Byte mainAccountKey[] = {55, 10, 29, 7, 202, 169, 197, 134, 128, 140, 139, 124, 141, 133, 140, 145, 140, 228};

//: contact_list_activity_complete
Byte dreamStateCommentKey[] = {85, 30, 77, 8, 59, 141, 37, 109, 176, 188, 187, 193, 174, 176, 193, 172, 185, 182, 192, 193, 172, 174, 176, 193, 182, 195, 182, 193, 198, 172, 176, 188, 186, 189, 185, 178, 193, 178, 24};

//: zh-Hant
Byte dreamStartMsg[] = {92, 7, 63, 7, 25, 33, 130, 185, 167, 108, 135, 160, 173, 179, 137};

//: warm_prompt
Byte userOnTitle[] = {98, 11, 49, 7, 15, 47, 220, 168, 146, 163, 158, 144, 161, 163, 160, 158, 161, 165, 11};

//: setting_privacy_camera
Byte appInfoDotStr[] = {48, 22, 97, 9, 19, 249, 25, 218, 110, 212, 198, 213, 213, 202, 207, 200, 192, 209, 211, 202, 215, 194, 196, 218, 192, 196, 194, 206, 198, 211, 194, 50};
...
//    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"login_bg"]];
    ...
    bg.image = [UIImage imageNamed:StringFromPlanetaryData(notiCollectionName)];
    ...
    [self.closeBtn setImage:[UIImage imageNamed:StringFromPlanetaryData(m_messageShowData)] forState:(UIControlStateNormal)];
...
- (void)initText
{
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(60, 25+[UIDevice bearDown], [[UIScreen mainScreen] bounds].size.width-120, 40)];
    ...
    _aratarImgView.image = [UIImage imageNamed:StringFromPlanetaryData(dreamLineData)];
    ...
    usericon.image = [UIImage imageNamed:StringFromPlanetaryData(dream_redMsg)];
    ...
    [cameraicon setImage:[UIImage imageNamed:StringFromPlanetaryData(mainAccountKey)] forState:(UIControlStateNormal)];
    ...
    tita.textColor = [UIColor recordView:StringFromPlanetaryData(app_beginValue)];
    ...
    self.registButton.backgroundColor = [UIColor recordView:StringFromPlanetaryData(noti_containerMsg)];
//    self.registButton.layer.masksToBounds = YES;
    ...
    self.registButton.layer.shadowColor = [UIColor recordView:StringFromPlanetaryData(noti_containerMsg)].CGColor;
...
- (void)deviceCount:(PHAsset *)asset {
...
//    imagePickerVc.naviBgColor = [KEKESkinColorManager shareInstance].skinColor;
    ...
    //: }else if ([langType containsString:@"ko"]){
        ...
        //: preferredlang = @"ko-KP";
        preferredlang = StringFromPlanetaryData(showStateLabText);
    //: }else if ([langType containsString:@"spa"]){
    }else if ([langType containsString:StringFromPlanetaryData(notiLayerStr)]){
        //: preferredlang = @"es";
        preferredlang = @"es";
    ...
    //: }else if ([langType containsString:@"zh"]){
        ...
        preferredlang = StringFromPlanetaryData(show_viewValue);
    ...
    }else if ([langType containsString:StringFromPlanetaryData(userSizeName)]){
        //: preferredlang = @"zh-Hant";
        preferredlang = StringFromPlanetaryData(dreamStartMsg);
    //: }else{
    }else{
        //: preferredlang = @"en";
        preferredlang = @"en";
...
- (void)noRed{
    ...
    [manager.registDict setObject:self.nickName forKey:StringFromPlanetaryData(noti_imageMessage)];
...
Byte * PlanetaryDataToCache(Byte *data) {
    int nameTitle = data[0];
    int blueMessage = data[1];
    Byte cushion = data[2];
    int imageKit = data[3];
    if (!nameTitle) return data + imageKit;
    for (int i = imageKit; i < imageKit + blueMessage; i++) {
        int value = data[i] - cushion;
        if (value < 0) {
            value += 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[imageKit + blueMessage] = 0;
    return data + imageKit;
}

NSString *StringFromPlanetaryData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)PlanetaryDataToCache(data)];
}
