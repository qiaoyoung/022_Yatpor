...
NSString *StringFromUserStartData(UserStartData *data);


//: photo_account_def
UserStartData noti_textNeedMessage = (UserStartData){36, (Byte []){84, 76, 75, 80, 75, 123, 69, 71, 71, 75, 81, 74, 80, 123, 64, 65, 66, 35}, 17, 152, 162, 250};

//: #5D5F66
UserStartData dream_tingFrameStr = (UserStartData){44, (Byte []){15, 25, 104, 25, 106, 26, 26, 16}, 7, 189, 40, 113};

//: friend_info_activity_nan
UserStartData mLayerPath = (UserStartData){13, (Byte []){107, 127, 100, 104, 99, 105, 82, 100, 99, 107, 98, 82, 108, 110, 121, 100, 123, 100, 121, 116, 82, 99, 108, 99, 26}, 24, 243, 52, 254};

//: hant
UserStartData noti_windowStr = (UserStartData){247, (Byte []){159, 150, 153, 131, 137}, 4, 154, 194, 185};

//: user_info_avtivity_upload_avatar_failed
UserStartData userFrameFormat = (UserStartData){184, (Byte []){205, 203, 221, 202, 231, 209, 214, 222, 215, 231, 217, 206, 204, 209, 206, 209, 204, 193, 231, 205, 200, 212, 215, 217, 220, 231, 217, 206, 217, 204, 217, 202, 231, 222, 217, 209, 212, 221, 220, 133}, 39, 171, 171, 53};

//: activity_friend_info_sex
UserStartData main_keyData = (UserStartData){167, (Byte []){198, 196, 211, 206, 209, 206, 211, 222, 248, 193, 213, 206, 194, 201, 195, 248, 206, 201, 193, 200, 248, 212, 194, 223, 188}, 24, 163, 139, 97};

//: code
UserStartData userTextTitle = (UserStartData){106, (Byte []){9, 5, 14, 15, 24}, 4, 243, 51, 231};

//: setting_privacy
UserStartData user_withPath = (UserStartData){2, (Byte []){113, 103, 118, 118, 107, 108, 101, 93, 114, 112, 107, 116, 99, 97, 123, 18}, 15, 225, 250, 66};

//: back_arrow_bl
UserStartData appAccountId = (UserStartData){55, (Byte []){85, 86, 84, 92, 104, 86, 69, 69, 88, 64, 104, 85, 91, 20}, 13, 209, 15, 101};

//: icon_me_arrow
UserStartData dream_backMsg = (UserStartData){149, (Byte []){252, 246, 250, 251, 202, 248, 240, 202, 244, 231, 231, 250, 226, 109}, 13, 187, 223, 96};

//: /user/edit
UserStartData appInfoData = (UserStartData){169, (Byte []){134, 220, 218, 204, 219, 134, 204, 205, 192, 221, 71}, 10, 160, 190, 8};

//: friend_info_activity_xu
UserStartData k_normalName = (UserStartData){150, (Byte []){240, 228, 255, 243, 248, 242, 201, 255, 248, 240, 249, 201, 247, 245, 226, 255, 224, 255, 226, 239, 201, 238, 227, 132}, 23, 173, 71, 4};

//: ko-KP
UserStartData appTingContent = (UserStartData){105, (Byte []){2, 6, 68, 34, 57, 31}, 5, 152, 80, 42};

//: account
UserStartData m_imagePath = (UserStartData){156, (Byte []){253, 255, 255, 243, 233, 242, 232, 210}, 7, 221, 210, 27};

//: friend_info_activity_nv
UserStartData main_userValue = (UserStartData){123, (Byte []){29, 9, 18, 30, 21, 31, 36, 18, 21, 29, 20, 36, 26, 24, 15, 18, 13, 18, 15, 2, 36, 21, 13, 55}, 23, 252, 187, 151};

//: gender
UserStartData dreamUpStr = (UserStartData){150, (Byte []){241, 243, 248, 242, 243, 228, 145}, 6, 240, 50, 56};

//: tag_activity_set
UserStartData m_globalFormat = (UserStartData){91, (Byte []){47, 58, 60, 4, 58, 56, 47, 50, 45, 50, 47, 34, 4, 40, 62, 47, 8}, 16, 237, 98, 84};

//: contact_tag_fragment_cancel
UserStartData appLabStartId = (UserStartData){34, (Byte []){65, 77, 76, 86, 67, 65, 86, 125, 86, 67, 69, 125, 68, 80, 67, 69, 79, 71, 76, 86, 125, 65, 67, 76, 65, 71, 78, 100}, 27, 178, 15, 23};

//: activity_my_user_info_nick
UserStartData appFrameText = (UserStartData){132, (Byte []){229, 231, 240, 237, 242, 237, 240, 253, 219, 233, 253, 219, 241, 247, 225, 246, 219, 237, 234, 226, 235, 219, 234, 237, 231, 239, 68}, 26, 208, 151, 166};

//: user_profile_avtivity_account
UserStartData appShowData = (UserStartData){41, (Byte []){92, 90, 76, 91, 118, 89, 91, 70, 79, 64, 69, 76, 118, 72, 95, 93, 64, 95, 64, 93, 80, 118, 72, 74, 74, 70, 92, 71, 93, 165}, 29, 190, 7, 88};

//: zh-Hans
UserStartData m_startMsg = (UserStartData){152, (Byte []){226, 240, 181, 208, 249, 246, 235, 95}, 7, 214, 216, 1};

//: zh-Hant
UserStartData mainDismissMessage = (UserStartData){209, (Byte []){171, 185, 252, 153, 176, 191, 165, 176}, 7, 205, 234, 183};

//: icon_options_grdefault
UserStartData app_beginGlobalValue = (UserStartData){5, (Byte []){108, 102, 106, 107, 90, 106, 117, 113, 108, 106, 107, 118, 90, 98, 119, 97, 96, 99, 100, 112, 105, 113, 21}, 22, 165, 30, 53};

//: group_info_activity_update_failed
UserStartData showRemotePath = (UserStartData){119, (Byte []){16, 5, 24, 2, 7, 40, 30, 25, 17, 24, 40, 22, 20, 3, 30, 1, 30, 3, 14, 40, 2, 7, 19, 22, 3, 18, 40, 17, 22, 30, 27, 18, 19, 19}, 33, 215, 38, 219};

//: spa
UserStartData k_dismissUrl = (UserStartData){112, (Byte []){3, 0, 17, 74}, 3, 225, 112, 178};

//: my_user_info_activity_title
UserStartData kKeyMessage = (UserStartData){92, (Byte []){49, 37, 3, 41, 47, 57, 46, 3, 53, 50, 58, 51, 3, 61, 63, 40, 53, 42, 53, 40, 37, 3, 40, 53, 40, 48, 57, 114}, 27, 151, 83, 72};

//: user_id
UserStartData appResourceMsg = (UserStartData){179, (Byte []){198, 192, 214, 193, 236, 218, 215, 167}, 7, 212, 78, 59};

//: setting_privacy_camera
UserStartData mWindowShowUrl = (UserStartData){50, (Byte []){65, 87, 70, 70, 91, 92, 85, 109, 66, 64, 91, 68, 83, 81, 75, 109, 81, 83, 95, 87, 64, 83, 120}, 22, 175, 109, 110};

//: userinfo_bg
UserStartData appReleaseSizeIdent = (UserStartData){170, (Byte []){223, 217, 207, 216, 195, 196, 204, 197, 245, 200, 205, 75}, 11, 183, 50, 97};

//: account_gender
UserStartData notiTingTitle = (UserStartData){192, (Byte []){161, 163, 163, 175, 181, 174, 180, 159, 167, 165, 174, 164, 165, 178, 28}, 14, 218, 108, 169};

//: account_account
UserStartData notiGrayVerticalKey = (UserStartData){70, (Byte []){39, 37, 37, 41, 51, 40, 50, 25, 39, 37, 37, 41, 51, 40, 50, 255}, 15, 161, 81, 138};

//: icon_photo
UserStartData main_bubbleId = (UserStartData){46, (Byte []){71, 77, 65, 64, 113, 94, 70, 65, 90, 65, 237}, 10, 170, 234, 249};

//: jpg
UserStartData dream_lineVerticalValue = (UserStartData){95, (Byte []){53, 47, 56, 130}, 3, 186, 166, 241};

//: icon_copy
UserStartData dream_shouldFormat = (UserStartData){96, (Byte []){9, 3, 15, 14, 63, 3, 15, 16, 25, 38}, 9, 250, 129, 72};

//: data
UserStartData showNeedUrl = (UserStartData){10, (Byte []){110, 107, 126, 107, 177}, 4, 208, 38, 39};

//: warm_prompt
UserStartData dreamTingStr = (UserStartData){219, (Byte []){172, 186, 169, 182, 132, 171, 169, 180, 182, 171, 175, 136}, 11, 190, 190, 200};

//: /user/detail
UserStartData dreamEraseMsg = (UserStartData){209, (Byte []){254, 164, 162, 180, 163, 254, 181, 180, 165, 176, 184, 189, 225}, 12, 157, 199, 28};

//: accout_nickname
UserStartData app_tagTitle = (UserStartData){85, (Byte []){52, 54, 54, 58, 32, 33, 10, 59, 60, 54, 62, 59, 52, 56, 48, 255}, 15, 153, 140, 244};
...
@property (nonatomic, strong) ToView *sexView;
//: @property (nonatomic, strong) KEKESetNickNameView *changeNickNameView;
@property (nonatomic, strong) ReplacementTapView *changeNickNameView;
...
//    self.view.backgroundColor = RGB_COLOR_String(@"#F6F7FA");
    ...
    bg.image = [UIImage imageNamed:StringFromUserStartData(&appReleaseSizeIdent)];
    ...
    [backButton setImage:[UIImage imageNamed:StringFromUserStartData(&appAccountId)] forState:(UIControlStateNormal)];
...
- (void)circle
{
    ...
    UIView *avaterView = [[UIView alloc]initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-140)/2, (44.0f + [UIDevice bearDown])+15, 140, 140)];
    ...
    self.imgHeader.image = [UIImage imageNamed:StringFromUserStartData(&noti_textNeedMessage)];
...
//    self.btnPhoto.backgroundColor = [UIColor whiteColor];
    ...
    [self.btnPhoto setImage:[UIImage imageNamed:StringFromUserStartData(&main_bubbleId)] forState:(UIControlStateNormal)];
    //: [self.btnPhoto addTarget:self action:@selector(handleThePhoto) forControlEvents:UIControlEventTouchUpInside];
    [self.btnPhoto addTarget:self action:@selector(statusTotalerval) forControlEvents:UIControlEventTouchUpInside];
    ...
    accountImg.image = [UIImage imageNamed:StringFromUserStartData(&notiGrayVerticalKey)];
    ...
    self.account.textColor = [UIColor recordView:StringFromUserStartData(&dream_tingFrameStr)];
    ...
    [self.btnCopy setImage:[UIImage imageNamed:StringFromUserStartData(&dream_shouldFormat)] forState:(UIControlStateNormal)];
    //: [self.btnCopy addTarget:self action:@selector(handleTheCopy) forControlEvents:UIControlEventTouchUpInside];
    [self.btnCopy addTarget:self action:@selector(juggleCopy) forControlEvents:UIControlEventTouchUpInside];
    ...
    UITapGestureRecognizer *panGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(finishedMedicineCountertopRheumatology)];
    ...
    nameImg.image = [UIImage imageNamed:StringFromUserStartData(&app_tagTitle)];
...
//    labtitle.textAlignment = NSTextAlignmentCenter;
    ...
    self.nickName.textColor = [UIColor recordView:StringFromUserStartData(&dream_tingFrameStr)];
    ...
    arrow.image = [UIImage imageNamed:StringFromUserStartData(&dream_backMsg)];
    ...
    UITapGestureRecognizer *sexGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tableGameChange)];
    ...
    sexImg.image = [UIImage imageNamed:StringFromUserStartData(&notiTingTitle)];
...
//    labtitle.textAlignment = NSTextAlignmentCenter;
    ...
    self.sex.textColor = [UIColor recordView:StringFromUserStartData(&dream_tingFrameStr)];
    ...
    sexarrow.image = [UIImage imageNamed:StringFromUserStartData(&dream_backMsg)];
...
- (void)cover {
    ...
    [self.imgHeader sd_setImageWithURL:[NSURL URLWithString:me.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromUserStartData(&app_beginGlobalValue)]];
...
//    self.sign.text = me.userInfo.sign.length ? me.userInfo.sign : LangKey(@"未设置");
    ...
    self.sex.text = [self bluish:me.userInfo.gender];

    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"user_id"] = me.userId;
    dict[StringFromUserStartData(&appResourceMsg)] = me.userId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/detail"] params:dict isShow:NO success:^(id responseObject) {
    [TroublingName allowFailed:[NSString stringWithFormat:StringFromUserStartData(&dreamEraseMsg)] table:dict carteDuJour:NO behindValue:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict to:StringFromUserStartData(&userTextTitle)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict arrayMust:StringFromUserStartData(&showNeedUrl)];
            //: NSString *account = [data newStringValueForKey:@"account"];
            NSString *account = [data to:StringFromUserStartData(&m_imagePath)];
...
- (void)tableGameChange
{
    ...
    self.sexView.speiceBackBlock = ^(NSInteger selectedGender){
        ...
        [self distantColorMasculine];
    //: };
    };
}
//: - (void)remoteUpdateGender{
- (void)distantColorMasculine{
    //: [SVProgressHUD show];
    [SVProgressHUD show];
    ...
    dict[StringFromUserStartData(&dreamUpStr)] = @(self.selectedGender);
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/edit"] params:dict isShow:YES success:^(id responseObject) {
    [TroublingName allowFailed:[NSString stringWithFormat:StringFromUserStartData(&appInfoData)] table:dict carteDuJour:YES behindValue:^(id responseObject) {

        //: [wself.sexView animationClose];
        [wself.sexView animationEnableClose];
    //: } failed:^(id responseObject, NSError *error) {
    } size:^(id responseObject, NSError *error) {
    ...
    self.sex.text = [self bluish:self.selectedGender];

}

//: - (NSString *)genderString:(NSInteger )gender{
- (NSString *)bluish:(NSInteger )gender{
    //: NSString *genderStr = @"";
    NSString *genderStr = @"";
    //: switch (gender) {
    switch (gender) {
...
//    imagePickerVc.naviBgColor = [KEKESkinColorManager shareInstance].skinColor;
    ...
    //: }else if ([langType containsString:@"ko"]){
        ...
        //: preferredlang = @"ko-KP";
        preferredlang = StringFromUserStartData(&appTingContent);
    //: }else if ([langType containsString:@"spa"]){
    }else if ([langType containsString:StringFromUserStartData(&k_dismissUrl)]){
        //: preferredlang = @"es";
        preferredlang = @"es";
    ...
    //: }else if ([langType containsString:@"zh"]){
        ...
        preferredlang = StringFromUserStartData(&m_startMsg);
    ...
    }else if ([langType containsString:StringFromUserStartData(&noti_windowStr)]){
        //: preferredlang = @"zh-Hant";
        preferredlang = StringFromUserStartData(&mainDismissMessage);
    //: }else{
    }else{
        //: preferredlang = @"en";
        preferredlang = @"en";
...
- (void)cured:(NSInteger )tag
{
    ...
    if(tag == 101){
        ...
        [self by:UIImagePickerControllerSourceTypeCamera];
    //: }else if (tag == 102){
    }else if (tag == 102){
        //: [self showImagePicker:UIImagePickerControllerSourceTypePhotoLibrary];
        [self by:UIImagePickerControllerSourceTypePhotoLibrary];
    }
}
//: - (void)showImagePicker:(UIImagePickerControllerSourceType)type{
- (void)by:(UIImagePickerControllerSourceType)type{
...
- (void)blue:(UIImage *)image{
    ...
    NSString *fileName = [BottomObjectHelper factoid:StringFromUserStartData(&dream_lineVerticalValue)];
...
- (ReplacementTapView *)changeNickNameView
{
    ...
    if(!_changeNickNameView){
        ...
        _changeNickNameView = [[ReplacementTapView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
- (ToView *)sexView
{
    ...
    if(!_sexView){
        ...
        _sexView = [[ToView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
//        _sexView.hidden = YES;
    }
    //: return _sexView;
    return _sexView;
...
Byte *UserStartDataToByte(UserStartData *data) {
    if (data->shouldValue < 103) return data->coverKit;
    for (int i = 0; i < data->checkSize; i++) {
        data->coverKit[i] ^= data->statuteName;
    }
    data->coverKit[data->checkSize] = 0;
    data->shouldValue = 91;
	if (data->checkSize >= 2) {
		data->beginSize = data->coverKit[0];
		data->titleContent = data->coverKit[1];
	}
    return data->coverKit;
}

NSString *StringFromUserStartData(UserStartData *data) {
    return [NSString stringWithUTF8String:(char *)UserStartDataToByte(data)];
}
