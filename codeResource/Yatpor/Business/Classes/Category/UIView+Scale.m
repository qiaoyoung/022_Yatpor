...
NSString * const show_nameKey = @"kAlertViewUserInfo";
...
- (void)setUserInfo:(id)userInfo {
    ...
    objc_setAssociatedObject(self, (__bridge const void *)(show_nameKey), userInfo, OBJC_ASSOCIATION_ASSIGN);
}

//: - (id)userInfo {
- (id)userInfo {
    //: return objc_getAssociatedObject(self, (__bridge const void *)(kViewUserInfo));
    return objc_getAssociatedObject(self, (__bridge const void *)(show_nameKey));
}
...
- (void)paths:(UITapGestureRecognizer *)sender {
...
- (UIViewController *)maxSum {
    ...
    return (UIViewController *)[self searched:self];
}
...
- (UIView *)key:(Class)superViewClass{
    ...
    if (![superView isKindOfClass:superViewClass]) {
        ...
        superView = [superView key:superViewClass];
    }
