...
#import "NSDictionary+Scale.h"

//: @implementation NSDictionary (KIAdditions)
@implementation NSDictionary (Scale)

//: - (NSString *)jsonString{
- (NSString *)enableContent{
