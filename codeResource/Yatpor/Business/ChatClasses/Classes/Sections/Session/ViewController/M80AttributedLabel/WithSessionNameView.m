...
static NSString* const k_kitCropPath = @"\u2026";

//: @interface M80AttributedLabel ()
@interface WithSessionNameView ()
...
@implementation WithSessionNameView
...
- (NSAttributedString *)cell:(NSString *)text
{
    //: if ([text length])
    if ([text length])
    {
...
- (NSAttributedString *)attributedOrDraw:(NSMutableAttributedString *)drawString
{
    //: if (drawString)
    if (drawString)
    {
...
- (NSMutableAttributedString *)input:(NSAttributedString *)attributedString {
    // 匹配 [表情]
    ...
    if (attrM.length > 0) {
        ...
        NSArray<NSTextCheckingResult *> *emoticonResults = [[WithSessionNameView title] matchesInString:attrM.string options:kNilOptions range:attrM.yy_rangeOfAll];
...
- (NSMutableAttributedString*)rangeRemote:(NSMutableAttributedString *)wholeText {
...
- (void)setText:(NSString *)text
{
    ...
    NSAttributedString *attributedText = [self cell:text];
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
    ...
    NSAttributedString *attString = [self attributedOrDraw:[[NSMutableAttributedString alloc] initWithAttributedString:attributedText]];
    //: _attributedString = [self needHightText:[self transformEmojiDescToEomjiImageWithAttributedString:attString]];
    _attributedString = [self rangeRemote:[self input:attString]];
...
- (void)pamphlet:(NSString *)text
{
    //: NSAttributedString *attributedText = [self attributedString:text];
    NSAttributedString *attributedText = [self cell:text];
    //: [self appendAttributedText:attributedText];
    [self complete:attributedText];
}

//: - (void)appendAttributedText:(NSAttributedString *)attributedText
- (void)complete:(NSAttributedString *)attributedText
{
