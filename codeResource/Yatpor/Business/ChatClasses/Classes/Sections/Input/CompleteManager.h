...
@interface BackgroundBar : NSObject
...
@interface PutOptionLayout : NSObject
...
@interface SpecialSessionView : NSObject
//: @property (nonatomic,strong) NIMInputEmoticonLayout *layout;
@property (nonatomic,strong) PutOptionLayout *layout;
...
//: @interface ContentInputEmoticonManager : NSObject
