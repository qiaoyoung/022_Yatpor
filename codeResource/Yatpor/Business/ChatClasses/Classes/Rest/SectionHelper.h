 ...
 *
 * 如果您在使用 SectionHelper 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
+ (__kindof NSURLSessionTask *)max:(NSString *)URL
...
+ (__kindof NSURLSessionTask *)eventFailure:(NSString *)URL
                         //: parameters:(id)parameters
                         on:(id)parameters
                            //: success:(YLHttpRequestSuccess)success
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)languageOff:(NSString *)URL
                         //: parameters:(id)parameters
                         cell:(id)parameters
                      //: responseCache:(YLHttpRequestCache)responseCache
...
+ (__kindof NSURLSessionTask *)image:(NSString *)URL
                                      //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)greenishPlace:(NSString *)URL
                                       //: parameters:(id)parameters
                                       add:(id)parameters
                                             //: name:(NSString *)name
                                             overColor:(NSString *)name
                                             //: data:(NSData *)data
                                             enable:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         magnitudeVideo:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        minimum_strong:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         searched:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          success:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          full:(YLHttpRequestFailed)failure;
...
+ (__kindof NSURLSessionTask *)selected:(NSString *)URL
                                        //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)message:(NSString *)URL
                                      ...
                                      length:(YLHttpProgress)progress
                                       ...
                                       workflow:(void(^)(NSString *filePath))success
                                       //: failure:(YLHttpRequestFailed)failure;
...
+ (void)setParadigm:(void(^)(AFHTTPSessionManager *sessionManager))sessionManager;
