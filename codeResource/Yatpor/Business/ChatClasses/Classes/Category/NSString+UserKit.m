...
@implementation NSString (UserKit)
...
- (NSString *)resign {
    ...
    NSString * result = [self media:[UserKit totalSend].languageTable];
    //: return result;
    return result;
}
...
- (NSString *)media:(NSString *)table {
    ...
    NSBundle * languageBundle = [UserKit totalSend].languageBundle;
    //: return [self nim_localizedByBundle:languageBundle table:table];
    return [self drag:languageBundle quantitySuccess:table];
}

//: - (NSString *)nim_localizedByBundle:(NSBundle *)bundle table:(NSString *)table {
- (NSString *)drag:(NSBundle *)bundle quantitySuccess:(NSString *)table {
    //: if (!bundle) {
    if (!bundle) {
        //: return self;
        return self;
