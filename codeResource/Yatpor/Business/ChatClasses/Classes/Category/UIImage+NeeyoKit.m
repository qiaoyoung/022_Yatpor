...
+ (UIImage *)labelId:(NSString *)imageName contentRecordingId:(NSString *)chartletId{
...
+ (CGSize)listBy:(CGSize)originSize
                              //: minSize:(CGSize)imageMinSize
                              wisecrack:(CGSize)imageMinSize
                              //: maxSize:(CGSize)imageMaxSiz{
                              currentTo:(CGSize)imageMaxSiz{
    //: CGSize size;
    CGSize size;
...
+ (UIImage *)need:(NSString *)imageName {
    //: if (!imageName) {
    if (!imageName) {
        //: return nil;
        return nil;
    ...
    NSString *emojiPath = [[EqualArchiveManager sharedManager] getEmojiPath];
...
- (UIImage *)under
{
    ...
    CGFloat pixels = [[BubbleReplacement currentDevice] suggestImagePixels];
...
- (UIImage *)viewUploadInput: (CGFloat)suggestPixels
{
...
- (UIImage *)scaleBy: (CGFloat)maxPixels
{
    //: CGFloat width = self.size.width;
    CGFloat width = self.size.width;
    //: CGFloat height= self.size.height;
...
- (UIImage *)notLength:(CGSize)newSize
{
    //: CGFloat width = self.size.width;
    CGFloat width = self.size.width;
    //: CGFloat height= self.size.height;
...
- (UIImage *)replacement:(CGSize)targetSize
{
    // 裁剪两边
