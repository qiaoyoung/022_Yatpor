...
- (instancetype)initWithFrame:(CGRect)frame textContainer:(NSTextContainer *)textContainer
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(progressCan:) name:UITextViewTextDidChangeNotification object:self];
    }
    //: return self;
    return self;
}
...
- (void)progressCan:(NSNotification *)notification
{
    //: [self updatePlaceholder];
    [self table];
}
