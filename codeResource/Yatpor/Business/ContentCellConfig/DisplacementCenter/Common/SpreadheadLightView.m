...
- (void)showRecent: (NSInteger)page
{
...
- (NSInteger)towardSend:(NSInteger)value bar:(NSInteger)min fileMax:(NSInteger)max{
    //: if (max < min) {
    if (max < min) {
        //: max = min;
        max = min;
...
- (void)show:(NSInteger)currentPage
{
    ...
    NSInteger first = [self towardSend:currentPage - 1 bar:0 fileMax:count - 1];
    //: NSInteger last = [self pageInBound:currentPage + 1 min:0 max:count - 1];
    NSInteger last = [self towardSend:currentPage + 1 bar:0 fileMax:count - 1];
