...
#import "YYAnimatedImageView+Comb.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: @implementation YYAnimatedImageView (iOS14)
@implementation YYAnimatedImageView (Comb)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(layering:));
