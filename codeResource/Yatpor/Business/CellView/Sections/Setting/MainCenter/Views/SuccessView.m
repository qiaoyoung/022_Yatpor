...
Byte noti_blueText[] = {26, 22, 80, 6, 58, 95, 6, 21, 34, 36, 25, 22, 41, 15, 28, 31, 23, 25, 30, 15, 32, 17, 35, 35, 39, 31, 34, 20, 154};

//: #F7BA00
Byte main_backName[] = {68, 7, 56, 12, 244, 82, 226, 19, 1, 122, 83, 162, 235, 14, 255, 10, 9, 248, 248, 69};

//: safe_success_step
Byte user_messageFormat[] = {31, 17, 31, 13, 77, 75, 103, 160, 231, 61, 191, 123, 207, 84, 66, 71, 70, 64, 84, 86, 68, 68, 70, 84, 84, 64, 84, 85, 70, 81, 123};

//: safe_success_tip
Byte dream_showBackFormat[] = {40, 16, 63, 5, 92, 52, 34, 39, 38, 32, 52, 54, 36, 36, 38, 52, 52, 32, 53, 42, 49, 250};

//: safe_arrow_next
Byte main_contentValue[] = {12, 15, 7, 4, 108, 90, 95, 94, 88, 90, 107, 107, 104, 112, 88, 103, 94, 113, 109, 198};

//: NotificationLogout
Byte kStateText[] = {24, 18, 49, 8, 132, 71, 142, 89, 29, 62, 67, 56, 53, 56, 50, 48, 67, 56, 62, 61, 27, 62, 54, 62, 68, 67, 203};

//: Complete_operation
Byte show_verticalPath[] = {67, 18, 56, 11, 63, 121, 236, 155, 173, 108, 120, 11, 55, 53, 56, 52, 45, 60, 45, 39, 55, 56, 45, 58, 41, 60, 49, 55, 54, 48};

//: Read_agree_agreement
Byte showOperationFormat[] = {48, 20, 71, 9, 26, 163, 81, 32, 202, 11, 30, 26, 29, 24, 26, 32, 43, 30, 30, 24, 26, 32, 43, 30, 30, 38, 30, 39, 45, 248};
        ...
        [[[NIMSDK sharedSDK] loginManager] logout:^(NSError *error)
         {
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:StringFromDoingData(kStateText) object:nil];
        //: }];
        }];
    //: }];
    }];
...
- (UIImageView *)img
{
    ...
    if(!_img){
        ...
        _img = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromDoingData(dream_showBackFormat)]];
    }
    //: return _img;
    return _img;
}
...
- (UIView *)nextBox
{
    ...
    if(!_nextBox){
        ...
        img1.image = [UIImage imageNamed:StringFromDoingData(user_messageFormat)];
        ...
        img2.image = [UIImage imageNamed:StringFromDoingData(user_messageFormat)];
        ...
        img3.image = [UIImage imageNamed:StringFromDoingData(user_messageFormat)];
        ...
        arrow1.image = [UIImage imageNamed:StringFromDoingData(main_contentValue)];
        ...
        arrow2.image = [UIImage imageNamed:StringFromDoingData(main_contentValue)];
...
- (UIButton *)sureBtn {
    ...
    if (!_sureBtn) {
        ...
        _sureBtn.backgroundColor = [UIColor recordView:StringFromDoingData(main_backName)];
//        _sureBtn.layer.borderWidth = 0.5;
//        _sureBtn.layer.borderColor = [UIColor colorWithRed:255/255.0 green:72/255.0 blue:61/255.0 alpha:1].CGColor;
        //: _sureBtn.layer.cornerRadius = 10;
        _sureBtn.layer.cornerRadius = 10;
        //: _sureBtn.layer.shadowColor = [UIColor colorWithHexString:@"#F7BA00"].CGColor;
        _sureBtn.layer.shadowColor = [UIColor recordView:StringFromDoingData(main_backName)].CGColor;
...
Byte * DoingDataToCache(Byte *data) {
    int compass = data[0];
    int needValue = data[1];
    Byte chemLab = data[2];
    int bubbleTing = data[3];
    if (!compass) return data + bubbleTing;
    for (int i = bubbleTing; i < bubbleTing + needValue; i++) {
        int value = data[i] + chemLab;
        if (value > 255) {
            value -= 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[bubbleTing + needValue] = 0;
    return data + bubbleTing;
}
