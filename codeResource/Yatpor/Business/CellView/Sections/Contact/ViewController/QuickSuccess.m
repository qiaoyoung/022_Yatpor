...
#import "QuickSuccess.h"
//: #import "NSString+LJExtension.h"
#import "NSString+Custom.h"

//: @implementation CCCContactPerson
@implementation QuickSuccess

//: - (instancetype)initWithCNContact:(CNContact *)contact {
- (instancetype)initWithLabel:(CNContact *)contact {
    //: self = [super init];
    self = [super init];
    //: if (self)
    if (self)
    {
        ...
        if ([contact isKeyAvailable:CNContactPhoneNumbersKey])
        {
            ...
            for (CNLabeledValue *labeledValue in contact.phoneNumbers)
            {
                ...
                if ([MessageDisturbing sharedValue:labeledValue]) {
                    //: NIMContactPhone *phoneModel = [[NIMContactPhone alloc] initWithLabeledValue:labeledValue];
                    MessageDisturbing *phoneModel = [[MessageDisturbing alloc] initWithGray:labeledValue];
...
@implementation MessageDisturbing

//: - (instancetype)initWithLabeledValue:(CNLabeledValue *)labeledValue {
- (instancetype)initWithGray:(CNLabeledValue *)labeledValue {
    //: self = [super init];
    self = [super init];
    //: if (self)
    if (self)
    {
        ...
        self.phone = [NSString latchkey:phoneNumber];
...
+ (BOOL)sharedValue:(CNLabeledValue *)labeledValue {
    //: CNPhoneNumber *phoneValue = labeledValue.value;
    CNPhoneNumber *phoneValue = labeledValue.value;
    //: NSString *phoneNumber = phoneValue.stringValue;
    NSString *phoneNumber = phoneValue.stringValue;
    //: NSString *userful = [NSString lj_filterSpecialString:phoneNumber];
    NSString *userful = [NSString latchkey:phoneNumber];
