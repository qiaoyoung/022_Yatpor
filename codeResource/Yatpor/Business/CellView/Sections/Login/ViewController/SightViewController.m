...
//: iOS%@
Byte showExamineIdent[] = {81, 5, 32, 12, 146, 73, 171, 12, 142, 33, 236, 136, 73, 47, 51, 5, 32, 90};

//: #333333
Byte kRedKey[] = {20, 7, 69, 8, 82, 5, 110, 118, 222, 238, 238, 238, 238, 238, 238, 102};

//: activity_register_agree
Byte k_layerStr[] = {14, 23, 58, 5, 212, 39, 41, 58, 47, 60, 47, 58, 63, 37, 56, 43, 45, 47, 57, 58, 43, 56, 37, 39, 45, 56, 43, 43, 82};

//: login_icon_user
Byte userEndPath[] = {57, 15, 37, 10, 38, 196, 52, 218, 102, 67, 71, 74, 66, 68, 73, 58, 68, 62, 74, 73, 58, 80, 78, 64, 77, 99};

//: telname
Byte user_singleIdent[] = {77, 7, 97, 13, 40, 142, 159, 163, 199, 155, 132, 242, 16, 19, 4, 11, 13, 0, 12, 4, 204};

//: __SCOPED__
Byte show_modelTitle[] = {49, 10, 60, 9, 153, 63, 86, 207, 219, 35, 35, 23, 7, 19, 20, 9, 8, 35, 35, 254};

//: deviceid
Byte app_tableName[] = {52, 8, 96, 5, 17, 4, 5, 22, 9, 3, 5, 9, 4, 17};

//: code
Byte app_tingUrl[] = {86, 4, 53, 13, 102, 120, 11, 110, 115, 246, 247, 66, 105, 46, 58, 47, 48, 214};

//: activity_comment_setting_ys
Byte dream_modelLinePath[] = {50, 27, 26, 9, 76, 190, 139, 148, 136, 71, 73, 90, 79, 92, 79, 90, 95, 69, 73, 85, 83, 83, 75, 84, 90, 69, 89, 75, 90, 90, 79, 84, 77, 69, 95, 89, 56};

//: login_activity_login_success
Byte userEndId[] = {68, 28, 15, 13, 184, 8, 50, 211, 13, 254, 221, 62, 128, 93, 96, 88, 90, 95, 80, 82, 84, 101, 90, 103, 90, 101, 106, 80, 93, 96, 88, 90, 95, 80, 100, 102, 84, 84, 86, 100, 100, 196};

//: friend_verify_avtivity_net_error
Byte m_messageName[] = {10, 32, 24, 6, 199, 199, 78, 90, 81, 77, 86, 76, 71, 94, 77, 90, 81, 78, 97, 71, 73, 94, 92, 81, 94, 81, 92, 97, 71, 86, 77, 92, 71, 77, 90, 90, 87, 90, 200};

//: activity_login_login
Byte noti_viewUrl[] = {61, 20, 70, 5, 164, 27, 29, 46, 35, 48, 35, 46, 51, 25, 38, 41, 33, 35, 40, 25, 38, 41, 33, 35, 40, 36};

//: activity_register_title
Byte m_imageKey[] = {22, 23, 9, 13, 230, 223, 211, 147, 121, 153, 121, 139, 49, 88, 90, 107, 96, 109, 96, 107, 112, 86, 105, 92, 94, 96, 106, 107, 92, 105, 86, 107, 96, 107, 99, 92, 92};

//: issup
Byte app_containerIdent[] = {45, 5, 13, 6, 226, 8, 92, 102, 102, 104, 99, 178};

//: ic_visible
Byte app_dismissKey[] = {66, 10, 8, 7, 75, 60, 81, 97, 91, 87, 110, 97, 107, 97, 90, 100, 93, 243};

//: #F7BA00
Byte notiSelectedIdent[] = {17, 7, 67, 8, 67, 46, 233, 54, 224, 3, 244, 255, 254, 237, 237, 188};

//: lang
Byte notiGlobalUrl[] = {79, 4, 12, 4, 96, 85, 98, 91, 221};

//: SELF MATCHES %@
Byte appEnableFormat[] = {96, 15, 46, 12, 75, 204, 193, 93, 30, 226, 160, 87, 37, 23, 30, 24, 242, 31, 19, 38, 21, 26, 23, 37, 242, 247, 18, 64};

//: login_icon_pwd
Byte userValueTitle[] = {83, 14, 54, 14, 62, 227, 108, 45, 88, 98, 100, 142, 18, 18, 54, 57, 49, 51, 56, 41, 51, 45, 57, 56, 41, 58, 65, 46, 42};

//: UserPassWord
Byte mainNameFormat[] = {3, 12, 79, 11, 223, 251, 215, 24, 154, 63, 248, 6, 36, 22, 35, 1, 18, 36, 36, 8, 32, 35, 21, 184};

//: login_activity_login_failed
Byte dream_processorId[] = {92, 27, 88, 7, 194, 74, 41, 20, 23, 15, 17, 22, 7, 9, 11, 28, 17, 30, 17, 28, 33, 7, 20, 23, 15, 17, 22, 7, 14, 9, 17, 20, 13, 12, 234};

//: data
Byte showTextTitle[] = {61, 4, 92, 9, 6, 149, 34, 97, 44, 8, 5, 24, 5, 160};

//: UserAccount
Byte mByName[] = {66, 11, 69, 9, 110, 201, 134, 42, 42, 16, 46, 32, 45, 252, 30, 30, 42, 48, 41, 47, 217};

//: account
Byte mCollectionIdent[] = {60, 7, 29, 11, 79, 3, 53, 178, 143, 209, 140, 68, 70, 70, 82, 88, 81, 87, 250};

//: #8282A7
Byte notiResourceMsg[] = {82, 7, 37, 6, 34, 126, 254, 19, 13, 19, 13, 28, 18, 236};

//: #5D5F66
Byte dreamContainerUrl[] = {4, 7, 21, 11, 123, 171, 233, 45, 151, 146, 242, 14, 32, 47, 32, 49, 33, 33, 111};

//: register_account_activity_account
Byte app_viewIdent[] = {68, 33, 56, 6, 197, 32, 58, 45, 47, 49, 59, 60, 45, 58, 39, 41, 43, 43, 55, 61, 54, 60, 39, 41, 43, 60, 49, 62, 49, 60, 65, 39, 41, 43, 43, 55, 61, 54, 60, 115};

//: client
Byte mCoverStateUrl[] = {7, 6, 92, 11, 130, 63, 194, 158, 211, 81, 215, 7, 16, 13, 9, 18, 24, 44};

//: systems
Byte showQueryedEndText[] = {70, 7, 36, 9, 142, 137, 221, 22, 238, 79, 85, 79, 80, 65, 73, 79, 78};

//: #999999
Byte appBackgroundStr[] = {68, 7, 6, 5, 241, 29, 51, 51, 51, 51, 51, 51, 91};

//: login_agreement_press
Byte mTagName[] = {41, 21, 10, 7, 34, 178, 45, 98, 101, 93, 95, 100, 85, 87, 93, 104, 91, 91, 99, 91, 100, 106, 85, 102, 104, 91, 105, 105, 81};

//: token
Byte appLabIdent[] = {76, 5, 50, 13, 237, 32, 167, 36, 193, 149, 96, 199, 98, 66, 61, 57, 51, 60, 174};

//: /user/login
Byte k_labFormat[] = {98, 11, 22, 13, 100, 247, 205, 143, 58, 237, 239, 62, 54, 25, 95, 93, 79, 92, 25, 86, 89, 81, 83, 88, 41};

//: vpn
Byte appDismissTitleId[] = {63, 3, 31, 11, 207, 145, 148, 205, 125, 62, 187, 87, 81, 79, 50};

//: login_error
Byte app_infoData[] = {92, 11, 83, 13, 255, 111, 76, 43, 90, 200, 203, 100, 152, 25, 28, 20, 22, 27, 12, 18, 31, 31, 28, 31, 123};

//: activity_login_welcome
Byte k_searchId[] = {67, 22, 21, 7, 82, 62, 41, 76, 78, 95, 84, 97, 84, 95, 100, 74, 87, 90, 82, 84, 89, 74, 98, 80, 87, 78, 90, 88, 80, 66};

//: ^[A-Za-z0-9_]{6,12}$
Byte k_singleStartText[] = {83, 20, 74, 10, 229, 230, 62, 109, 24, 214, 20, 17, 247, 227, 16, 23, 227, 48, 230, 227, 239, 21, 19, 49, 236, 226, 231, 232, 51, 218, 122};

//: ic_invisible
Byte appUpKey[] = {71, 12, 65, 14, 205, 74, 69, 87, 9, 225, 91, 218, 18, 185, 40, 34, 30, 40, 45, 53, 40, 50, 40, 33, 43, 36, 97};

//: ^[A-Za-z0-9_]{6,18}$
Byte userInfoStr[] = {61, 20, 79, 10, 254, 140, 125, 60, 13, 125, 15, 12, 242, 222, 11, 18, 222, 43, 225, 222, 234, 16, 14, 44, 231, 221, 226, 233, 46, 213, 246};

//: ios
Byte k_withNeedMsg[] = {68, 3, 60, 5, 103, 45, 51, 55, 114};

//: tun
Byte show_tagId[] = {33, 3, 44, 6, 220, 213, 72, 73, 66, 136};

//: type
Byte notiOmitMsg[] = {80, 4, 35, 4, 81, 86, 77, 66, 118};

//: login_success
Byte dream_textDataIdent[] = {89, 13, 9, 8, 53, 167, 96, 129, 99, 102, 94, 96, 101, 86, 106, 108, 90, 90, 92, 106, 106, 217};

//: password
Byte user_dismissGlobalFormat[] = {61, 8, 67, 6, 76, 123, 45, 30, 48, 48, 52, 44, 47, 33, 190};

//: tap
Byte user_textUrl[] = {68, 3, 38, 11, 103, 25, 136, 209, 244, 121, 187, 78, 59, 74, 130};

//: login_agreement_normal
Byte userCoverMsg[] = {77, 22, 97, 11, 83, 197, 160, 98, 225, 253, 248, 11, 14, 6, 8, 13, 254, 0, 6, 17, 4, 4, 12, 4, 13, 19, 254, 13, 14, 17, 12, 0, 11, 204};

//: ppp
Byte notiProcessorGlobalKey[] = {69, 3, 10, 12, 141, 66, 210, 207, 228, 166, 234, 101, 102, 102, 102, 76};

//: login_bg
Byte noti_customDotId[] = {39, 8, 34, 9, 209, 198, 77, 83, 104, 74, 77, 69, 71, 76, 61, 64, 69, 173};

//: register_account_activity_psw
Byte showTingIdent[] = {19, 29, 11, 7, 235, 55, 221, 103, 90, 92, 94, 104, 105, 90, 103, 84, 86, 88, 88, 100, 106, 99, 105, 84, 86, 88, 105, 94, 107, 94, 105, 110, 84, 101, 104, 108, 49};

//: nimtoken
Byte userValueNeedId[] = {94, 8, 78, 13, 204, 61, 180, 253, 236, 208, 193, 4, 44, 32, 27, 31, 38, 33, 29, 23, 32, 154};

//: login_logo
Byte appWithMsg[] = {29, 10, 8, 14, 97, 184, 181, 99, 190, 210, 26, 249, 2, 60, 100, 103, 95, 97, 102, 87, 100, 103, 95, 103, 108};

//: RegistFinshNotification
Byte dreamGrayName[] = {47, 23, 3, 7, 25, 107, 153, 79, 98, 100, 102, 112, 113, 67, 102, 107, 112, 101, 75, 108, 113, 102, 99, 102, 96, 94, 113, 102, 108, 107, 145};

//: msg
Byte dream_withCustomStr[] = {39, 3, 16, 5, 55, 93, 99, 87, 76};
...
//: NotificationLogout
Byte noti_labUpValue[] = {86, 18, 17, 6, 128, 135, 61, 94, 99, 88, 85, 88, 82, 80, 99, 88, 94, 93, 59, 94, 86, 94, 100, 99, 95};
...
- (void)viewDidLoad {
    ...
    bg.image = [UIImage imageNamed:StringFromFrameData(noti_customDotId)];
    //: [self.view addSubview:bg];
    [self.view addSubview:bg];

    //: [NTESRegistConfigManager shareConfigManager].loginVC = self;
    [LengthOff lipogramManager].loginVC = self;
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(registToLifeStory:) name:StringFromFrameData(dreamGrayName) object:nil];
...
- (void)beInfo {
    ...
    if (userDefaults.language && userDefaults.language.length <= 0) {
        ...
        [TroublingName nameConfig:^(NSDictionary * _Nonnull configDict) {//处理第一次启动语言问题
            //: if (configDict.allKeys.count > 0) {
            if (configDict.allKeys.count > 0) {
                //: NIMUserDefaults *userDefaults = [NIMUserDefaults standardUserDefaults];
                NameDefaults *userDefaults = [NameDefaults argument];
                //: NSString *lang = [configDict newStringValueForKey:@"lang"];
                NSString *lang = [configDict to:StringFromFrameData(notiGlobalUrl)];
...
- (void)item {
    ...
    if (![PathBottom voiceManager].isRequestAutoLoginFinish){
        //: return;
        return;
    }

    //: if (![NIMUserDefaults standardUserDefaults].autoLogin.boolValue){
    if (![NameDefaults argument].autoLogin.boolValue){
        //: [self initUI];
        [self initAsFile];
        //: return;
        return;
    ...
    if ([NameDefaults argument].accid.length > 0){
        //: [self initUI];
        [self initAsFile];
        //: return;
        return;
    ...
    [TroublingName redUser:^(NSDictionary * _Nonnull data) {
        ...
        if (data.allKeys.count > 0) {
            ...
            [SVProgressHUD dismissWithDelay:0.1 completion:^{
                ...
                [PathBottom voiceManager].isloading = NO;
...
-(void)registToLifeStory:(NSNotification *)notification{
    //: NSDictionary *dict = notification.object;
    NSDictionary *dict = notification.object;
    //: _usernameTextField.text = [dict newStringValueForKey:@"UserAccount"];
    _usernameTextField.text = [dict to:StringFromFrameData(mByName)];
    //: _passwordTextField.text = [dict newStringValueForKey:@"UserPassWord"];
    _passwordTextField.text = [dict to:StringFromFrameData(mainNameFormat)];
...
- (void)initAsFile{
    ...
    _logoImageView = [[UIImageView alloc] initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-120)/2, (44.0f + [UIDevice bearDown])+10, 120, 120)];
    ...
    _logoImageView.image = [UIImage imageNamed:StringFromFrameData(appWithMsg)];
    ...
    self.titleImg.image = [UIImage imageNamed:StringFromFrameData(userEndPath)];
    ...
    if ([NameDefaults argument].accountName && [NameDefaults argument].accountName.length > 0){
        //: _usernameTextField.text = [NIMUserDefaults standardUserDefaults].accountName;
        _usernameTextField.text = [NameDefaults argument].accountName;
    }
    ...
    self.titleImg2.image = [UIImage imageNamed:StringFromFrameData(userValueTitle)];
    ...
    _passwordTextField.textColor = [UIColor recordView:StringFromFrameData(kRedKey)];
...
//    self.passwordTextField.delegate = self;
    ...
    [self.secureButton setImage:[UIImage imageNamed:StringFromFrameData(app_dismissKey)] forState:UIControlStateNormal];
    //: [self.secureButton setImage:[UIImage imageNamed:@"ic_invisible"] forState:UIControlStateSelected];
    [self.secureButton setImage:[UIImage imageNamed:StringFromFrameData(appUpKey)] forState:UIControlStateSelected];
//    self.secureButton.hidden = YES;
    ...
    _loginButton.backgroundColor = [UIColor recordView:StringFromFrameData(notiSelectedIdent)];
...
//    _registerButton.backgroundColor = ThemeColor;
    ...
    [_registerButton setTitleColor:[UIColor recordView:StringFromFrameData(notiSelectedIdent)] forState:UIControlStateNormal];
...
//    _registerButton.layer.cornerRadius = 16;
    ...
    [_agreementButton setImage:[UIImage imageNamed:StringFromFrameData(userCoverMsg)] forState:UIControlStateNormal];
    //: [_agreementButton setImage:[UIImage imageNamed:@"login_agreement_press"] forState:UIControlStateSelected];
    [_agreementButton setImage:[UIImage imageNamed:StringFromFrameData(mTagName)] forState:UIControlStateSelected];
...
- (void)vacantCover:(UIButton *)sender {
    ...
    if (sender.selected) { // 按下去了就是明文
        ...
        [sender setImage:[UIImage imageNamed:StringFromFrameData(appUpKey)] forState:UIControlStateNormal];
    ...
    //: } else { 
        ...
        [sender setImage:[UIImage imageNamed:StringFromFrameData(app_dismissKey)] forState:UIControlStateNormal];
...
-(YYLabel *)protocolLabel{
    ...
    if (!_protocolLabel) {
        ...
        [text1 yy_setTextHighlightRange:NSMakeRange(0, originText.length)//设置点击的位置
                                  ...
                                  color:[UIColor recordView:StringFromFrameData(notiSelectedIdent)]
...
-(YYLabel *)registLabel{
    ...
    if (!_registLabel) {
        ...
        text1.yy_color = [UIColor recordView:StringFromFrameData(notiResourceMsg)];
...
-(void)panoramaContainer:(NSString*)account recordOf_strong:(NSString *)password{
...
- (BOOL)saveHolder
{
    ...
    NSDictionary *dict = CFBridgingRelease(CFNetworkCopySystemProxySettings());
        ...
        NSArray *keys = [dict[StringFromFrameData(show_modelTitle)]allKeys];
        //: for (NSString *key in keys) {
        for (NSString *key in keys) {
            //: if ([key rangeOfString:@"tap"].location != NSNotFound ||
            if ([key rangeOfString:StringFromFrameData(user_textUrl)].location != NSNotFound ||
                //: [key rangeOfString:@"tun"].location != NSNotFound ||
                [key rangeOfString:StringFromFrameData(show_tagId)].location != NSNotFound ||
                //: [key rangeOfString:@"ppp"].location != NSNotFound){
                [key rangeOfString:StringFromFrameData(notiProcessorGlobalKey)].location != NSNotFound){
                //: return YES;
                return YES;
            }
        }
...
- (BOOL)viewTitle:(NSString *)input {
    //: NSString *pattern = @"^[A-Za-z0-9_]{6,12}$";
    NSString *pattern = StringFromFrameData(k_singleStartText);

    //: NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", pattern];
    NSPredicate *predicate = [NSPredicate predicateWithFormat:StringFromFrameData(appEnableFormat), pattern];
    //: return [predicate evaluateWithObject:input];
    return [predicate evaluateWithObject:input];
}
//: - (BOOL)isPSDValidString:(NSString *)input {
- (BOOL)origin:(NSString *)input {
    //: NSString *pattern = @"^[A-Za-z0-9_]{6,18}$";
    NSString *pattern = StringFromFrameData(userInfoStr);
...
//    }
    ...
    [dict setObject:StringFromFrameData(k_withNeedMsg) forKey:StringFromFrameData(mCoverStateUrl)];
    //: [dict setObject:@"1" forKey:@"type"];
    [dict setObject:@"1" forKey:StringFromFrameData(notiOmitMsg)];
    //: [dict setObject:_usernameTextField.text forKey:@"account"];
    [dict setObject:_usernameTextField.text forKey:StringFromFrameData(mCollectionIdent)];
    //: [dict setObject:_passwordTextField.text forKey:@"password"];
    [dict setObject:_passwordTextField.text forKey:StringFromFrameData(user_dismissGlobalFormat)];
    //: [dict setObject:[NSString stringWithFormat:@"iOS%@",[ZCHttpRequestHeader deviceVersion]] forKey:@"telname"];
    [dict setObject:[NSString stringWithFormat:StringFromFrameData(showExamineIdent),[BigDate device]] forKey:StringFromFrameData(user_singleIdent)];
    //: [dict setObject:[ZCHttpRequestHeader getIOSVersion] forKey:@"systems"];
    [dict setObject:[BigDate begin] forKey:StringFromFrameData(showQueryedEndText)];
    //: [dict setObject:[SNDevice deviceIUUID] forKey:@"deviceid"];
    [dict setObject:[NonsolidColourTip by] forKey:StringFromFrameData(app_tableName)];

    //: [dict setObject:[self isVPNConnected]?@"1":@"0" forKey:@"vpn"];
    [dict setObject:[self saveHolder]?@"1":@"0" forKey:StringFromFrameData(appDismissTitleId)];
    ...
    [TroublingName allowFailed:[NSString stringWithFormat:StringFromFrameData(k_labFormat)] table:dict carteDuJour:NO behindValue:^(id responseObject) {
        ...
        NSString *code = [resultDict to:StringFromFrameData(app_tingUrl)];
        //: NSString *msg = [resultDict newStringValueForKey:@"msg"];
        NSString *msg = [resultDict to:StringFromFrameData(dream_withCustomStr)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {

            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict arrayMust:StringFromFrameData(showTextTitle)];
            //: __block NSString *nimtoken = [data newStringValueForKey:@"nimtoken"];
            __block NSString *nimtoken = [data to:StringFromFrameData(userValueNeedId)];
            //: __block NSString *accid = [data newStringValueForKey:@"id"];
            __block NSString *accid = [data to:@"id"];

            //: [NIMUserDefaults standardUserDefaults].loginToken = [data newStringValueForKey:@"token"];
            [NameDefaults argument].loginToken = [data to:StringFromFrameData(appLabIdent)];
            //: [NIMUserDefaults standardUserDefaults].accid = [data newStringValueForKey:@"id"];
            [NameDefaults argument].accid = [data to:@"id"];
            ...
            [[[NIMSDK sharedSDK] loginManager] login:accid token:nimtoken completion:^(NSError * _Nullable error) {
                ...
                [self.view makeToast:[MatronymicPath colorStreetwise:StringFromFrameData(userEndId)] duration:2.0 position:CSToastPositionCenter title:nil image:[UIImage imageNamed:StringFromFrameData(dream_textDataIdent)] style:style completion:nil];
                    ...
                    [NameDefaults argument].accountName = _usernameTextField.text;
                    //: [NIMUserDefaults standardUserDefaults].pCode = _passwordTextField.text;
                    [NameDefaults argument].pCode = _passwordTextField.text;
...
//            [self.view makeToast:msg duration:2.0 position:CSToastPositionCenter];
            ...
            [self.view makeToast:msg duration:2.0 position:CSToastPositionCenter title:nil image:[UIImage imageNamed:StringFromFrameData(app_infoData)] style:style completion:nil];
        }
...
Byte * FrameDataToCache(Byte *data) {
    int singleShould = data[0];
    int backComment = data[1];
    Byte labLine = data[2];
    int tableKit = data[3];
    if (!singleShould) return data + tableKit;
    for (int i = tableKit; i < tableKit + backComment; i++) {
        int value = data[i] + labLine;
        if (value > 255) {
            value -= 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[tableKit + backComment] = 0;
    return data + tableKit;
}
