...
+ (instancetype)old:(NSString *)badgeValue{
    //: if (!badgeValue) {
    if (!badgeValue) {
        //: badgeValue = @"";
        badgeValue = @"";
    ...
    DoingView *instance = [[DoingView alloc] init];
    //: instance.frame = [instance frameWithStr:badgeValue];
    instance.frame = [instance progress:badgeValue];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([[self badgeValue] length]) {
        ...
        [self drawDate:rect breakIn:context];
    //: }else{
    }else{
        //: [self drawWithOutContent:rect context:context];
        [self tableBubble:rect restoreity:context];
    }
...
- (void)setBadgeValue:(NSString *)badgeValue {
    ...
    self.frame = [self progress:badgeValue];
...
- (CGSize)badge:(NSString *)badgeValue{
...
- (CGRect)progress:(NSString *)badgeValue{
    //: CGSize badgeSize = [self badgeSizeWithStr:badgeValue];
    CGSize badgeSize = [self badge:badgeValue];
...
- (void)drawDate:(CGRect)rect breakIn:(CGContextRef)context{
...
- (void)tableBubble:(CGRect)rect restoreity:(CGContextRef)context{
    //: CGRect bodyFrame = self.bounds;
    CGRect bodyFrame = self.bounds;
